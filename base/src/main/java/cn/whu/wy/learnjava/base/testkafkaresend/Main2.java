...
public class Main2 {
    ...
    static void run(List<BizMsg> bizAMsgs, List<BizMsg> bizBMsgs) throws InterruptedException {
        ...
        new Thread(() -> bizAMsgs.forEach(Main2::send)).start();
        new Thread(() -> bizBMsgs.forEach(Main2::send)).start();
...
//        System.out.println("poll, start=" + start);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 每个业务发送的消息数量
        final int BIZ_COUNT = 100_0000;
        final int CACHE_SIZE = 20_0000;
        ...
        while (okSum + cacheSum < BIZ_COUNT * 2) {
